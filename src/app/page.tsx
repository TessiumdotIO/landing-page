          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-4xl mx-auto border border-white/20">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-[#ffc884] text-3xl font-bold mb-2">Dynamic</div>
                <div className="text-white/80 text-sm">Always Evolving</div>
              </div>
              <div className="text-center">
                <div className="text-[#ff5f6d] text-3xl font-bold mb-2">Onchain</div>
                <div className="text-white/80 text-sm">Verified Progress</div>
              </div>
              <div className="text-center">
                <div className="text-[#a022f5] text-3xl font-bold mb-2">Unique</div>
                <div className="text-white/80 text-sm">Your Journey</div>
              </div>
            </div>
