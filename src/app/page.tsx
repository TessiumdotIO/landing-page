    ...
    <div className="bg-white">
      ...
      >
        ...
        <p className="text-center sm:text-xl mt-5">
          The New Layer for Content: Gamified, Social and <br className="hidden sm:block" />
        ...
        <div className="flex items-center justify-center gap-3 mt-6">
          ...
          <button className="border border-gray-300 px-4 py-2 rounded-md cursor-pointer">Join Waitlist</button>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-[#461da1] via-[#5a2db6] to-[#461da1] py-16 px-5 mt-20">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-white font-semibold text-lg">Introducing</span>
          </div>

          <h2 className="text-4xl sm:text-6xl font-bold text-white mb-6">Tess Rank</h2>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 max-w-4xl mx-auto border border-white/20">
            <p className="text-white/90 text-lg sm:text-xl leading-relaxed mb-6">
              Your evolving onchain versatility score - built from every module, game, onchain checkpoint, wave, AI
              prompt and creator activity you complete across Tessium
            </p>

            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
              <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="text-[#ffc884] font-bold text-2xl mb-1">Modules</div>
                <div className="text-white/80 text-sm">Learn & Grow</div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="text-[#ff5f6d] font-bold text-2xl mb-1">Games</div>
                <div className="text-white/80 text-sm">Play & Evolve</div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="text-[#a022f5] font-bold text-2xl mb-1">Waves</div>
                <div className="text-white/80 text-sm">Community</div>
              </div>
              <div className="bg-white/10 rounded-xl p-4 backdrop-blur-sm border border-white/20 hover:bg-white/20 transition-all duration-300">
                <div className="text-white font-bold text-2xl mb-1">AI</div>
                <div className="text-white/80 text-sm">Create</div>
              </div>
            </div>
      ...
      <section className="px-5">
        <div className="flex items-center justify-center gap-1 mt-12 mb-5">
          <CornerRightDown size={20} className="" />
        </div>
        <Image
      ...
      <section className="sm:px-16 mb-20 mt-16">
        <h1 className="text-center sm:text-5xl text-3xl md:mb-16 text-[#461da1]">Our Core Features</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-10 px-5 mt-10">
          <div className="bg-[#f7f1ea] py-7 px-5 sm:px-7 rounded-xl">
            <Image src={"/tessium-edu.svg"} width={50} height={50} alt="tess" className="" />
            <p className="font-bold my-2">Tessium Edu</p>
            <p className="sm:w-[80%]">
              Gamified, structured web3 edtech — built to easily onboard the next wave of builders. <br /> Interactive learning
              tracks with AI companions. <br /> Onchain tracking and earning avenues for sustained progress. <br />
          ...
          <div className="bg-[#f1edfa] py-7 px-5 sm:px-7 rounded-xl relative overflow-hidden">
            ...
            <Image src={"/tessium-waves.svg"} width={50} height={50} alt="tess" className="" />
            <p className="font-bold my-2">Tessium Waves</p>
            <p className="sm:w-[80%]">
          ...
          <div className="bg-[#f7edee] py-7 px-5 sm:px-7 rounded-xl relative overflow-hidden">
            ...
            <Image src={"/tessium-games.svg"} width={50} height={50} alt="tess" className="" />
            <p className="font-bold my-2">Tessium Games</p>
            <p className="sm:w-[80%]">
          ...
          <div className="bg-[#f6f0fa] py-7 px-5 sm:px-7 rounded-xl relative overflow-hidden">
            ...
            <Image src={"/tessium-creator.svg"} width={50} height={50} alt="tess" className="" />
            <p className="font-bold my-2">Tessium Creator</p>
            <p className="sm:w-[80%]">Next generation creator engine…</p>
            <div className="flex items-center gap-2 flex-wrap text-sm mt-4 text-white">
