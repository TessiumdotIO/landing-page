...
const Navbar = () => {
  ...
  return (
    ...
    >
      <nav className="flex items-center justify-between my-5 mx-5 sm:my-7 sm:mx-10">
      ...
      {showMenu && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          />
          <div
            className="z-50 w-[70%] max-w-md border border-white/10 px-6 pt-8 shadow-xl absolute top-0 right-0 text-white"
            style={{
              background: "linear-gradient(180deg, #1A0F3D 0%, #2D1A5C 100%)",
            }}
          >
            ...
            <ul onClick={() => setShowMenu(false)} className="flex flex-col gap-4 items-end pb-20 text-xl">
              <li className="text-[#ffc884] font-bold">
                <Link href={"/"}>Home</Link>
              </li>
              <li className="text-white hover:text-[#461da1] transition-colors">
